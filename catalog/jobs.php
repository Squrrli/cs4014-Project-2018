						...
						<div class="row">
							...
							<div class="col-sm-3" id="user-info">
								...
								<form method="GET" action="jobs.php">
									...
									<div class="form-row refine-search">
										<input class="form-control"type="text" name="search" placeholder="Search" disabled="true">
									</div>
									<div class="form-row refine-search">
							...
							<div class="col-sm-9">
								...
								<?php
									for ($i=0; $i<10; $i++) { 
										print "<div class=\"container-fluid job-card\">
													<div class=\"row\">
														<div class=\"col-sm-10\">
															<p>user</p>	
														</div>
